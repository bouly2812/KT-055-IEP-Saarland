...
> **✅ Klarstellung:** Die Differentialgleichung beschreibt, **wie** sich der Sauerstoff ändert. Die logistische Kurve ist die **Lösung** dieser Differentialgleichung. Sie beschreibt, **wie** der Sauerstoff verläuft. Beides ist korrekt. Beides gehört zusammen. \(O_{2,\text{max}}\) ist keine willkürliche Zahl – es ist der Sättigungswert des Systems, der aus der Erdgeschichte abgeleitet wird.
